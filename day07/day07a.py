...
def check_equation(current_value, target_value, remaining_numbers):
    ...
    return check_equation(current_value + remaining_numbers[0], target_value, remaining_numbers[1:]) or check_equation(current_value * remaining_numbers[0], target_value, remaining_numbers[1:])
